...
| DOCSYNC-007 | Medium | Repository-wide markdown lint previously failed because non-canonical package/mobile/template/content markdown was still included in the repo-wide lint surface | Resolved | Added `.markdownlintignore`, fixed the remaining retired Java mobile docs issues and canonical long-line drift, then re-ran repo-wide markdownlint successfully |
