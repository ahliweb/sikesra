...
- [ ] The Hono setup route can reach PostgreSQL directly through the reviewed backend database connection and persist setup progress in the `public.sites` config during first-run bootstrap
