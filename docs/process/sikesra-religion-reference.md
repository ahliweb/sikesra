...
9. `#49` should add broader runtime usage, service-layer authorization, and audit-covered write/admin flows on top of that seam, repository boundary, migration contract, service boundary, and read-only route.
