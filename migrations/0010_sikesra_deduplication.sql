-- SIKESRA Migration 0010: Deduplication Candidates and Decisions
-- D1-compatible SQL; PostgreSQL-friendly design

-- Duplicate candidates: detected potential duplicates
...
-- Duplicate decisions: human decisions on duplicate candidates
