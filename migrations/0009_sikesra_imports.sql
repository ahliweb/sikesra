-- SIKESRA Migration 0009: Import Batches, Staging Rows, and Mapping Templates
-- D1-compatible SQL; PostgreSQL-friendly design

-- Import batches: track each Excel workbook import session
...
-- Import staging rows: raw and mapped data from each Excel row
...
-- Import mapping templates: column mapping configurations
