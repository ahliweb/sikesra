-- SIKESRA Migration 0003: Entities Core, Code Sequences, Code History, and Person Profiles
-- D1-compatible SQL; PostgreSQL-friendly design

-- Code sequences for 20-digit SIKESRA ID generation
-- Format: [kode_desa_kel_10][jenis_2][subjenis_2][sequence_6]
-- Unique per tenant/site/village/type/subtype
...
-- Code history for generated and corrected SIKESRA IDs
