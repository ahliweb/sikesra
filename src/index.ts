  ...
  return definePlugin({
    ...
    admin: {
      pages: [
        ...
        { path: "/entities", label: "Data Utama" },
        { path: "/verification", label: "Verifikasi" },
        { path: "/imports", label: "Import Excel" },
        { path: "/documents", label: "Dokumen" },
        { path: "/reports", label: "Laporan" },
        { path: "/regions", label: "Wilayah" },
        { path: "/access", label: "Atribut & Akses" },
