...
import { buildPublicContextFromEmDash, withHandlerSequence, type EmDashRouteContext, type RouteHandlerInput } from "./handler-utils";
...
export const publicMetadataHandler = async (routeCtx: EmDashRouteContext) => {
  const ctx = buildPublicContextFromEmDash(routeCtx);
