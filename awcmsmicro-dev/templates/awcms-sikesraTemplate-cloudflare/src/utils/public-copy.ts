const PUBLIC_COPY = {
	en: {
		...
		pluginEnabledDescription: "Registers `@ahliweb/awcms-sikesra` through the normal EmDash plugin path for audit, access-rights, and ABAC examples.",
	...
	id: {
		...
		pluginEnabledDescription: "Mendaftarkan `@ahliweb/awcms-sikesra` melalui jalur plugin EmDash normal untuk contoh audit, hak akses, dan ABAC.",
