-- NOTE: Must be applied as supabase_admin (extension owner) to override
-- extensions.index_advisor. If you reset locally as postgres, re-run this
-- migration while connected as supabase_admin.
DO $$
DECLARE
  proc_oid oid;
